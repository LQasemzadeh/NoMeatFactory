...
const Banner = () => {
    ...
    const banners = [
        ...
        },
        {
            ...
            description: "No Meat Factory is an innovation, exclusively plant based contract food manufacturing company that expeditiously creates and commercializes the finest plant-based foods for brand owners, retailers, food service and institutional customers. ",
